    ...
    <div className="main">    
      {showButton && (
        <div className="groups-container">
          ...
          <button className="creating-group-btn" onClick={()=>setIsPopUpVisible(true)}><span className="plus">+ Create Notes group</span></button>
        ...
        <div className="notes-container">
            ...
            <p className="para">Send and receive messages without keeping your phone online.                   Use Pocket Notes on up to 4 linked devices and 1 mobile phone</p> 
